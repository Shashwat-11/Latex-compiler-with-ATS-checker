    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg)] px-4">
      <div className="w-full max-w-[360px] animate-fade-in">
        ...
        <div className="rounded-[var(--radius-md)] border border-[var(--border-default)] bg-[var(--bg-elevated)] p-6 shadow-[var(--shadow-sm)]">
          {sessionExpired && (
            <div className="mb-3 rounded-[var(--radius-sm)] border border-[var(--warning-border, #f59e0b)] bg-[var(--warning-bg, #fffbeb)] px-3 py-2 text-[12px] text-[var(--warning-text, #92400e)]">
